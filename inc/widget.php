...
class HeartySliderWidget extends WP_Widget {

	function __construct() {

		$widget_options = array(
			'classname' => 'heartyslider_widget',
			'description' => 'Displays a HeartySlider instance',
		);

		parent::__construct( 'heartyslider_widget', 'HeartySlider Widget', $widget_options );
